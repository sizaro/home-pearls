...
<div class="max-w-5xl mx-auto px-4 py-6 text-[#3B2F2A]">
    ...
    <img
        ...
        class="w-full h-64 md:h-96 object-cover rounded-xl mb-6 border border-[#8B5E3C]/20"
    >

    <h1 class="text-3xl font-bold mb-2 text-[#8B5E3C]">
        {{ $this->product->name }}
    </h1>

    <p class="text-[#3B2F2A]/70 mb-8">
        {{ $this->product->description }}
    </p>

    <h2 class="text-xl font-semibold mb-4 text-[#8B5E3C]">
        Available Options
    </h2>
    ...
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            @foreach($this->productVariants as $variant)
                <div class="bg-[#F5F1ED] p-6 rounded-xl shadow-sm border border-[#8B5E3C]/20">
                    ...
                    <img
                        ...
                        class="w-full h-48 object-cover rounded-lg mb-2 border border-[#8B5E3C]/10"
                    >
