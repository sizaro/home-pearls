...
{{-- =========================
    MAIN CONTAINER (FIXED LAYOUT SAFE)
========================== --}}
<div class="bg-[#F5F1ED] w-full min-h-screen flex flex-col items-center justify-center">

    {{-- =========================
        ADVERT BANNER
    ========================== --}}
    <div class="bg-[#D4A373]/20 border border-[#D4A373]/40 p-3 text-center text-[#5C3A21]">
    ...
    <div class=" px-4 py-6">
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <div class="flex gap-3 overflow-x-auto pb-2 w-[80vw] whitespace-nowrap">
        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <div class="flex gap-4 overflow-x-auto pb-2 w-[80vw]">
                ...
                @foreach($this->products as $product)
                    <div class="min-w-[220px] bg-white rounded-xl shadow p-3">
                        ...
                        <a href="{{ route('products.show', $product['id']) }}"
                           class="inline-block mt-3 bg-[#8B5E3C] hover:bg-[#6F472E]
                                  text-white px-4 py-2 rounded-md font-semibold
                                  transition shadow-sm hover:shadow-md text-center">
                            View
                        </a>
